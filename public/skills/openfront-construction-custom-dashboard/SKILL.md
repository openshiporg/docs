---
name: openfront-construction-custom-dashboard
description: Plan and build a custom Openfront Construction operator dashboard by explaining the source architecture, interviewing the user, inspecting the current product code and contract, then adapting the built-in client or creating a safe separate client.
---

# Openfront Construction custom operator dashboard

Use this skill to adapt the built-in Construction operator dashboard or create a separately deployed client. Start from this product's current source—not Ecommerce conventions, screenshots, or another vertical's schema.
...
- Construction-specific operator navigation, screens, server actions, projections, and workflows mounted into that shell: `features/platform`.
...
The current product focus is project portfolio, estimates/bids, budgets, contracts, changes, field work, safety, documents, and progress billing. This list is orientation, not proof that every flow is safe or complete.
