---
name: openfront-dealership-custom-storefront
description: Plan and build a custom Openfront Dealership storefront by explaining the source architecture, interviewing the user, inspecting the current product code and contract, then adapting the built-in client or creating a safe separate client.
---

# Openfront Dealership custom storefront

Use this skill to adapt the built-in Dealership storefront or create a separately deployed client. Start from this product's current source—not Ecommerce conventions, screenshots, or another vertical's schema.
...
- Built-in Dealership customer experience, screens/modules, data loaders, sessions, and UI composition: `features/storefront`.
...
The current product focus is vehicle inventory/detail/compare, inquiry, finance intake, test-drive, trade-in, and service-request journeys. This list is orientation, not proof that every flow is safe or complete.
