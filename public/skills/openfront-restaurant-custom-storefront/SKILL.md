---
name: openfront-restaurant-custom-storefront
description: Plan and build a custom Openfront Restaurant storefront by explaining the source architecture, interviewing the user, inspecting the current product code and contract, then adapting the built-in client or creating a safe separate client.
---

# Openfront Restaurant custom storefront

Use this skill to adapt the built-in Restaurant storefront or create a separately deployed client. Start from this product's current source—not Ecommerce conventions, screenshots, or another vertical's schema.
...
- Built-in Restaurant customer experience, screens/modules, data loaders, sessions, and UI composition: `features/storefront`.
...
The current product focus is menu discovery, cart and ordering, customer account, reservations/waitlist, payment handoff, and order status. This list is orientation, not proof that every flow is safe or complete.
