---
name: openfront-salon-custom-storefront
description: Plan and build a custom Openfront Salon storefront by explaining the source architecture, interviewing the user, inspecting the current product code and contract, then adapting the built-in client or creating a safe separate client.
---

# Openfront Salon custom storefront

Use this skill to adapt the built-in Salon storefront or create a separately deployed client. Start from this product's current source—not Ecommerce conventions, screenshots, or another vertical's schema.
...
- Built-in Salon customer experience, screens/modules, data loaders, sessions, and UI composition: `features/storefront`.
...
The current product focus is services/stylists, availability and booking, appointments, gift cards, reviews, gallery, memberships, and customer access. This list is orientation, not proof that every flow is safe or complete.
