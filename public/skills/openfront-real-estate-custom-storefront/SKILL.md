---
name: openfront-real-estate-custom-storefront
description: Plan and build a custom Openfront Real Estate storefront by explaining the source architecture, interviewing the user, inspecting the current product code and contract, then adapting the built-in client or creating a safe separate client.
---

# Openfront Real Estate custom storefront

Use this skill to adapt the built-in Real Estate storefront or create a separately deployed client. Start from this product's current source—not Ecommerce conventions, screenshots, or another vertical's schema.
...
- Built-in Real Estate customer experience, screens/modules, data loaders, sessions, and UI composition: `features/storefront`.
...
The current product focus is listing discovery/detail, inquiries, showing requests, saved properties/searches, alerts, and customer deal milestones. This list is orientation, not proof that every flow is safe or complete.
