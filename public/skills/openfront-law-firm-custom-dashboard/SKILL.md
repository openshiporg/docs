---
name: openfront-law-firm-custom-dashboard
description: Plan and build a custom Openfront Law Firm operator dashboard by explaining the source architecture, interviewing the user, inspecting the current product code and contract, then adapting the built-in client or creating a safe separate client.
---

# Openfront Law Firm custom operator dashboard

Use this skill to adapt the built-in Law Firm operator dashboard or create a separately deployed client. Start from this product's current source—not Ecommerce conventions, screenshots, or another vertical's schema.
...
- Law Firm-specific operator navigation, screens, server actions, projections, and workflows mounted into that shell: `features/platform`.
...
The current product focus is intake, conflicts, matters, ethical walls, documents, deadlines, billing, trust records, portal sharing, and governance. This list is orientation, not proof that every flow is safe or complete.
