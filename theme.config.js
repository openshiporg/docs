export default {
  projectLink: 'https://github.com/openshiporg/docs',
  docsRepositoryBase: 'https://github.com/openshiporg/docs/blob/main',  // docsRepository: '',
  titleSuffix: " – Openship",
  logo: (
    <>
      <span
        className="mr-2 font-extrabold"
        style={{ width: "170px", paddingRight: "10px" }}
      >
      ...
      <span className="text-sm text-gray-600 dark:text-gray-300 font-normal hidden md:inline">
    ...
    return (
      <>
        ...
        <meta
          name="og:title"
          content={
            title ? title + " – Openship" : "Openship: fulfillment, solved"
          }
        />
        <meta name="apple-mobile-web-app-title" content="Openship Docs" />
      </>
    );
  },
  search: true,
  ...
  footerText: <>{new Date().getFullYear()} © Openship</>,
};
