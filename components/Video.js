      ...
      {showVideo ? (
        ...
        <div className="relative -mb-3">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center">
            <span className="mb-12" style={{ width: "35%", color: "#fff" }}>
            ...
            <div
              ...
              className="cursor-pointer relative w-20 text-blue-600 hover:text-blue-500 dark:text-blue-500 dark:hover:text-blue-400"
            >
              <svg
                viewBox="0 0 116 115"
                fill="currentColor"
            ...
            <text className="text-blue-100 text-2xl mt-12 font-medium italic">...in 5 minutes</text>
          </div>
        </div>
      )}
    </div>
