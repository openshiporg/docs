...
<List ml="sm">
  <List.Item>
    **accessToken**:
    <Badge mx={4} size="sm" color="gray" radius="sm" sx={{ height: 16 }}>
      string
    </Badge>
...
<iframe
  src="https://codesandbox.io/embed/github/openshiporg/openship-shop/tree/master/?codemirror=1&fontsize=14&hidenavigation=0&module=/pages/api/search-orders,/pages/api/search-products.js,/pages/api/create-order.js,/pages/api/cancel-order.js&theme=dark&view=editor"
  style={{
    width: "100%",
    height: "600px",
    overflow: "hidden",
